 ...
 *
 * This function covers the broad "Gutter Quote" landing page at city level —
...
function buildLocalSignalsBullets(
  ...
  if (growthSnippet) {
    bullets.push(
      `${cityName} is ${growthSnippet}, so demand for quality gutter is high; getting a quote early helps secure a slot.`
    );
  }
  return bullets;
}
...
export function getGutterCityPageContent(
  ...
  introParagraphs.push(
    `Get a free gutter quote in ${cityName}, ${stateName}. This page connects you with licensed local specialists for any pest problem — termites, rodents, bed bugs, mosquitoes, wildlife, and general gutter — no obligation.`
  );
  if (county || growthSnippet) {
    introParagraphs.push(
      county && growthSnippet
        ...
        : county
          ? `In ${county}, licensed gutter specialists work the area regularly and know local pest species, seasonal timing, and treatment regulations. A phone quote takes under 5 minutes.`
          : `${cityName} is ${growthSnippet}. Get a real gutter estimate from a licensed specialist who serves your area.`
    );
  } else {
    introParagraphs.push(
      `A licensed gutter specialist who serves ${cityName} can identify your pest problem and give you an honest treatment estimate over the phone in under 5 minutes.`
    );
  }
  ...
  if (!localParagraphs.length) {
    localParagraphs.push(`A licensed ${cityName} gutter specialist can give you a treatment quote tailored to your home and pest problem.`);
  }

  return {
    meta: {
      title: `Gutter Quote in ${cityName}, ${stateAbbr} | Free Estimates from Licensed Local Specialists`,
      description: `Free gutter quote in ${cityName}, ${stateName}. Licensed local specialists for termites, rodents, bed bugs, mosquitoes & wildlife. Upfront pricing, no obligation.`,
    },
    hero: {
      h1: `Free Gutter Quote in ${cityName}, ${stateName}`,
      sub: `Licensed ${cityName} gutter specialists for any pest problem — termites, rodents, bed bugs, mosquitoes, wildlife, and more. Honest estimates, no commitment.`,
    ...
    mainService: {
      h2: `Gutter Quote in ${cityName}, ${stateAbbr}`,
      ...
      localParagraphs,
      cost: `${cityName} gutter costs: $150 for general treatment to $8,000+ for termite fumigation`,
      whatAffects: [
      ...
      cta: `Get a Gutter Quote in ${cityName} — Call Now`,
    },
    whyCall: {
      h2: `Why ${cityName} Homeowners Get a Gutter Quote First`,
      paragraphs: [
        `A phone quote from a licensed ${cityName} gutter specialist gives you a realistic treatment budget before any work starts. Pest control costs${county ? ` in ${county}` : ""} vary significantly by pest type, infestation severity, and treatment method. A 5-minute call gets you a number — and a method recommendation — that reflects your specific situation.`,
        `It filters out the wrong contractors fast. Any ${cityName} specialist who won't give you a range over the phone before charging an inspection fee is worth avoiding. Serious gutter contractors are used to giving ballpark estimates; a free quote call tells you immediately who's worth your time.`,
    ...
    localSignals: {
      h2: `Gutter Quote Service Areas Near ${cityName}, ${stateName}`,
    ...
    faq: {
      h2: `Gutter Quote FAQ — ${cityName}, ${stateName}`,
      items: [
        {
          q: `How much does gutter cost in ${cityName}, ${stateAbbr}?`,
        ...
        {
          q: `Do gutter specialists need a license in ${cityName}?`,
          a: `Yes. ${stateName} requires gutter applicators to be licensed by the state. Wildlife removal specialists require separate permits for most species. All specialists connected through this page are licensed and insured in ${stateName}.`,
        },
        {
          q: `Can I get same-day gutter service in ${cityName}?`,
    ...
    closing: {
      h2: `Get Your Free Gutter Quote in ${cityName} Today`,
      text: `No forms. No waiting. No obligation. A licensed gutter specialist serving ${cityName}, ${stateName} can give you an honest estimate for any pest problem in under 5 minutes.`,
