...
export const SERVICE_CONTENT: Record<ServiceSlug, ServiceContent> = {
  "pest-control-quote": {
    heroTitle: "Free gutter quotes from local specialists",
    heroSub:
      "Compare estimates for inspections, treatments, and prevention programs. Get free quotes from licensed gutter specialists in your area—no obligation.",
    metaTitle: "Free Gutter Quotes | Compare Local Specialists by City",
    metaDescription:
      "Get free gutter quotes from local licensed specialists. Compare estimates for inspections, treatments, and prevention. Available in 4,000+ cities across the US.",
    intro:
      "Whether you need a one-time treatment, an annual prevention program, or a full inspection, getting multiple quotes helps you find the right price and the right specialist. Select your state below to find local gutter quotes in your city.",
    whyTitle: "Why get a gutter quote here",
    whyPoints: [
    ...
    ctaTitle: "Find gutter quotes in your city",
