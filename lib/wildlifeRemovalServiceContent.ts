    ...
    items: [
      {
        ...
        p: "Most US states require a wildlife removal license separate from a gutter license. Improperly trapping or relocating raccoons, bats, squirrels, or other protected species can result in fines. A licensed wildlife specialist handles permits, legal relocation, and documentation.",
      },
      {
